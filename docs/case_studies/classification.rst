...
Corrected images were produced with a *gain* :ref:`model <background:model>`, a 1 x 1 pixel :ref:`kernel <background:kernel shape>`, and a `MODIS NBAR <https://developers.google.com/earth-engine/datasets/catalog/MODIS_061_MCD43A4>`_  reference image.  Some detail on these choices is given in the `aerial mosaic correction <aerial_mosaic.rst>`_ study.

Using the blue and NIR pixel values as features, class densities (Gaussian kernel density estimates) are shown before and after correction below.
