...
class TestFuse(unittest.TestCase):
    ...
    def _test_homo_mask(self, src_filename, homo_filename, mask_partial=False):
    ...
    def _test_homo_profile(self, src_filename, homo_filename):
    ...
    def _test_homo_comparison(self, src_filename, homo_filename, ref_filename):
    ...
    def _test_ovl_block(self, ovl_block, prev_ovl_block, src_overlap, ref_overlap):
    ...
    def _test_ovl_blocks(self, raster_pair: RasterPairReader):
        ...
        for ovl_block in ovl_blocks[1:]:
            self._test_ovl_block(ovl_block, prev_ovl_block, src_overlap, ref_overlap)
    ...
    def _test_api(self, src_filename, ref_filename, test_filename, **kwargs):
        ...
        with self.subTest('Homogenised vs Reference', src_filename=src_filename, homo_filename=homo_filename,
            ...
            self._test_homo_comparison(src_filename, homo_filename, test_filename)

    def test_api_ref_space(self):
        """Test homogenisation API with model-crs=ref"""
        src_filename = self.source_root.joinpath('3324c_2015_1004_05_0182_RGB.tif')
        ref_filename = self.ref_root.joinpath('LANDSAT-LC08-C02-T1_L2-LC08_171083_20150923_B432_Byte.tif')
        ref2_filename = self.ref_root.joinpath('COPERNICUS-S2-20151003T075826_20151003T082014_T35HKC_B432_Byte.tif')
    ...
    def test_api_src_space(self):
        ...
        src_filename = self.ref_root.joinpath('LANDSAT-LC08-C02-T1_L2-LC08_171083_20150923_B432_Byte.vrt')
        ref_filename = self.ref_root.joinpath('COPERNICUS-S2-20151003T075826_20151003T082014_T35HKC_B432_Byte.tif')
    ...
    def test_cli(self):
        ...
        src_wildcard = self.source_root.joinpath('3324c_2015_*_RGB.tif')
        ref_filename = self.ref_root.joinpath('LANDSAT-LC08-C02-T1_L2-LC08_171083_20150923_B432_Byte.tif')
        ref2_filename = self.ref_root.joinpath('COPERNICUS-S2-20151003T075826_20151003T082014_T35HKC_B432_Byte.tif')
        param_list = [
        ...
        for param_dict in param_list:
            cli_str = (f'-v fuse {src_wildcard} {ref_filename} -k {param_dict["kernel_shape"][0]} '
                       f'{param_dict["kernel_shape"][1]} -m {param_dict["method"]} -od {self.homo_root} -c '
            ...
            for src_filename in src_file_list:
                ...
                with self.subTest('Homogenised vs Reference', src_filename=src_filename, homo_filename=homo_filename,
                    ...
                    self._test_homo_comparison(src_filename, homo_filename, ref2_filename)
##
