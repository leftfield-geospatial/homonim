...
def test_ref_force_proc_crs(float_100cm_ra: RasterArray, float_50cm_ra: RasterArray):
...
def test_src_force_proc_crs(float_100cm_ra: RasterArray, float_50cm_ra: RasterArray):
