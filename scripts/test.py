...
src_filename = pathlib.Path(
    r"V:\Data\HomonimEgs\Sequoia_2017_02_28_JonasKop\Source\odm_orthophoto - with cam radiom and with global mosaic adj 4Band.tif")
...
ref_filename = pathlib.Path(
    r"V:/Data/HomonimEgs/Sequoia_2017_02_28_JonasKop/Reference/S2_UctJonasPeak_UTM34S_SeqBands.tif")
...
hom = fuse.HomonimRefSpace(src_filename, ref_filename, win_size=[15, 15])
hom.homogenise_by_band(
    src_filename.parent.joinpath(src_filename.stem + '_HOMO_REF_L7_GainAndOffset' + src_filename.suffix))
